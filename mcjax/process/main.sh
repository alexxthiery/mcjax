...
if_train=false # Whether to train the model
...
inner_iters=50 # Number of inner steps for the IDEM algorithm
outer_iters=50 # Number of outer steps for the IDEM algorithm
